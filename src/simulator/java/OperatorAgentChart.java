 ...
 */
public class OperatorAgentChart implements Steppable {
    private boolean isAlive = true;
    private XYSeries inputSeries;
    private XYSeries inputForecastSeries;
    private XYSeries outputSeries;
    private XYSeries outputForecastSeries;
    private TimeSeriesChartGenerator chart;
    private JFrame chartFrame;
    private SinusoidalOperatorAgent agent;

    private int inputPoints = 200;
    private int outputPoints;

    private StreamStateWithUI gui;


    public OperatorAgentChart(Controller c, SinusoidalOperatorAgent agent, StreamStateWithUI gui) {
        this.gui = gui;
        this.agent = agent;
        this.outputPoints = agent.forecastPoints;
        // init
