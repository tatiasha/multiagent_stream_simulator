...
public class StreamStateWithUI extends GUIState {
    // workload
    public Display2D wldDisplay;
    public JFrame wldDisplayFrame;
    SparseGridPortrayal2D frameworkPortrayal = new SparseGridPortrayal2D();
    NetworkPortrayal2D dependenciesPortrayal = new NetworkPortrayal2D();

    //environment
    public Display2D envDisplay;
    public JFrame envDisplayFrame;
    SparseGridPortrayal2D nodesPortrayal = new SparseGridPortrayal2D();

    // agents
    ArrayList<String> operatorsSetPorts = null;
    ArrayList<String> nodesSetPorts = null;
    HashMap<String, OperatorAgentChart> opCharts;
    HashMap<String, NodeAgentChart> nodeCharts;
