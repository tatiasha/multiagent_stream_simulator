...
import model.algorithms.signal_distr_ga.SDGene;
...
class EventHandler {
    public static void handleEvent(ScenarioEvent event, StreamState state) {
        ...
        switch (eventClass) {
            ...
            case "KillTenantEvent": handleKillTenant((KillTenantEvent) event, state);
                break;
            case "StopSimEvent": handleStopSim(state);
                break;
            case "ScheduleEvent": handleSchedule(state);
                break;
    ...
    private static void handleNewNode(NewNodeEvent event, StreamState state) {
    ...
    private static void handleKillNode(KillNodeEvent event, StreamState state) {
    ...
    private static void handleNewTenant(NewTenantEvent event, StreamState state) {
    ...
    private static void handleKillTenant(KillTenantEvent event, StreamState state) {
    ...
    private static void handleStopSim(StreamState state) {
        state.finish();
    }

    private static void handleSchedule(StreamState state) {
    ...
    private static int findSlot(SparseGrid2D schedGrid, int nodeX) {
