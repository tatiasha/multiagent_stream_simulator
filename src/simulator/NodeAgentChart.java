 ...
 */
class NodeAgentChart implements Steppable {

    private boolean isAlive = true;

    private final ArrayList<XYSeries> statSeriesList;
    private final ArrayList<XYSeries> forecastSeriesList;
    private final XYSeries totalStatSeries;
    private final XYSeries totalForecastSeries;

    private final TimeSeriesChartGenerator chart;
    private final JFrame chartFrame;
    private final NodeAgent agent;
    private final ArrayList<SinusoidalOperatorAgent> opAgents;

    private int forecastPoints = 50;
    private final StreamState state;
    private final ArrayList<TimeSeriesAttributes> attr = new ArrayList<>();
    private final TimeSeriesAttributes totalStatAtt;
    private final TimeSeriesAttributes totalForAtt;
...
//        totalForAtt = new TimeSeriesAttributes(chart, totalForecastSeries, 1, null);
    ...
    private void checkForNewState() {
        ...
        seriesFromChartRemove.sort((o1, o2) -> -1*Integer.compare(o1, o2));
    ...
    private void addNewSeries(SinusoidalOperatorAgent op) {
