 ...
 */
class OperatorAgentPortrayal extends SimplePortrayal2D {

    private final Color color;
    private final String label;

    private final LabelledPortrayal2D labelPort;
    private final OvalPortrayal2D ovalPort;
    private final OvalPortrayal2D outOvalPort;
    ...
    public OperatorAgentPortrayal(Color color, String label) {
        ...
        labelPort.font = new Font(Font.DIALOG, Font.BOLD, 26);
